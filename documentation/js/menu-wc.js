...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">hyhproj documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-522cd7bb849436a54aee5baaf948d8d6"' : 'data-target="#xs-components-links-module-AppModule-522cd7bb849436a54aee5baaf948d8d6"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-522cd7bb849436a54aee5baaf948d8d6"' :
                                            'id="xs-components-links-module-AppModule-522cd7bb849436a54aee5baaf948d8d6"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/MydashboardComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">MydashboardComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/TopmatchesComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">TopmatchesComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/NavBar.html" data-type="entity-link">NavBar</a>
                            </li>
                            <li class="link">
                                <a href="classes/TwitterUser.html" data-type="entity-link">TwitterUser</a>
                            </li>
                            <li class="link">
